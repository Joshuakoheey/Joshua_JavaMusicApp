...
public class RadioPlayer1Activity extends AppCompatActivity
{
    ...
    private RadioPlayer1Storage musicolle = new RadioPlayer1Storage();
    ...
    public void shufflesong(View view)
    {
        if(shuffleFlag)
        {
            ...
            musicolle = new RadioPlayer1Storage();
        }
        else
        {
