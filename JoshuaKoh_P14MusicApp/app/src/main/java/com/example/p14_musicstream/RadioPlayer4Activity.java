...
public class RadioPlayer4Activity extends AppCompatActivity
{
    ...
    private RadioPlayer4Storage musicolle = new RadioPlayer4Storage();
    ...
    public void shufflesong(View view)
    {
        if(shuffleFlag)
        {
            ...
            musicolle = new RadioPlayer4Storage();
        }
        else
        {
