...
public class RadioPlayer3Activity extends AppCompatActivity
{
    ...
    private RadioPlayer3Storage musicolle = new RadioPlayer3Storage();
    ...
    public void shufflesong(View view)
    {
        if(shuffleFlag)
        {
            ...
            musicolle = new RadioPlayer3Storage();
        }
        else
        {
